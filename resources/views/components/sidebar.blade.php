...
<ul class="sidebar-nav" data-coreui="navigation">
    ...
    <li
        class="nav-group {{ request()->routeIs('admin.master.*') || request()->routeIs('master-*') || request()->routeIs('pasien-pmo.*') ? 'show' : '' }}">
        <a class="nav-link nav-group-toggle" href="#">
            <span class="nav-icon"><i class="ri ri-folder-line"></i></span> Master
        </a>
        <ul class="nav-group-items">
            ...
            @can('master-pasien.index')
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.master.pasien') ? 'active' : '' }}"
                        href="{{ route('admin.master.pasien') }}">
                        <span class="nav-icon"><i class="ri ri-user-line"></i></span> Pasien
                    </a>
                </li>
            @endcan
    ...
    @canany(['jadwal-mo.index', 'jadwal-cgd.index', 'pengingat-mo.index', 'pengingat-cgd.index'])
        ...
        <li
            class="nav-group {{ request()->routeIs('jadwal-mo.*') || request()->routeIs('jadwal-cgd.*') || request()->routeIs('pengingat-mo.*') || request()->routeIs('pengingat-cgd.*') ? 'show' : '' }}">
            <a class="nav-link nav-group-toggle" href="#">
                <span class="nav-icon"><i class="ri ri-briefcase-line"></i></span> Transaksi
            </a>
            <ul class="nav-group-items">
                @can('jadwal-mo.index')
                    <li class="nav-item">
