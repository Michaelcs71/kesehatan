    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1">
                <i class="ri ri-book-line text-primary me-2"></i>
                <span id="entityName">Detail Artikel</span>
            </h4>
...
<div class="row g-4">
    <div class="col-lg-8">
        <x-card title="Isi Artikel" icon="ri-book-line">
        ...
        <x-card title="Status & Audit" icon="ri-information-line">
            <table class="table table-borderless table-sm mb-0">
                ...
                <tr>
                    ...
                    <td class="fw-semibold small" id="detail-kategori">-</td>
                </tr>
                <tr>
...
window.whenKesehatanReady(function() {
    ...
    const CONFIG = {
        ROUTES: {
            ...
            SHOW_DATA: '{{ route('konten-edukasi.show-data', $id) }}',
        },
    };
    ...
    .done(function(d) {
        ...
        $('#detail-kategori').text(d.kategori || '-');
