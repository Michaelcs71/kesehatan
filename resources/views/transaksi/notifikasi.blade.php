...
@section('page-header')
    <nav aria-label="breadcrumb" class="small">
        <ol class="breadcrumb mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Log Notifikasi</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1">🔔 Log Notifikasi</h4>
            <small class="text-muted">Riwayat notifikasi yang sudah terkirim.</small>
        </div>
        <div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-5 text-center">
        ...
        <h5 class="fw-bold mt-3">Log Notifikasi</h5>
