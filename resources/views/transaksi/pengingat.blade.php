...
@section('page-header')
    <nav aria-label="breadcrumb" class="small">
        <ol class="breadcrumb mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pengingat Obat</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1">⏰ Pengingat Obat</h4>
            <small class="text-muted">Atur dan kelola pengingat untuk obat-obat Anda.</small>
        </div>
        <div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-5 text-center">
        ...
        <h5 class="fw-bold mt-3">Pengingat Obat</h5>
